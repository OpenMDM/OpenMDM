...
urlpatterns = patterns('',
    ...
    url(r'^property_list/(?P<plist_id>\w+)/$',              views.property_list_detail,                     name='property_list_detail'),
    url(r'^property_list/(?P<plist_id>\w+)/download/$',     views.property_list_download,                   name='property_list_download'),
